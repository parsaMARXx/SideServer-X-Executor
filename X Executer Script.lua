...
local XExecuter = Instance.new("ScreenGui")
...
XExecuter.Name = "X Executer"
XExecuter.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
XExecuter.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Frame.Parent = XExecuter
Frame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
Frame.BackgroundTransparency = 0.400
Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
Frame.BorderSizePixel = 0
Frame.Position = UDim2.new(0.329276621, 0, 0.217935875, 0)
Frame.Size = UDim2.new(0.341219276, 0, 0.563627243, 0)
...
TextBox.Position = UDim2.new(0.0399999991, 0, 0.0933333337, 0)
TextBox.Size = UDim2.new(0.926666677, 0, 0.708888888, 0)
TextBox.Font = Enum.Font.SourceSansBold
TextBox.PlaceholderColor3 = Color3.fromRGB(139, 139, 139)
...
ExecuteButton.Position = UDim2.new(0.0399999991, 0, 0.848888874, 0)
ExecuteButton.Size = UDim2.new(0.312000006, 0, 0.111111112, 0)
...
ClearButton.Position = UDim2.new(0.653333306, 0, 0.848888874, 0)
ClearButton.Size = UDim2.new(0.312000006, 0, 0.111000001, 0)
...
Title.Size = UDim2.new(1, 0, 0.0933333337, 0)
Title.Font = Enum.Font.SourceSansBold
Title.Text = "X Executer"
...
do -- Frame.ExecuteModule
	local script = Instance.new('ModuleScript', Frame)
	script.Name = "ExecuteModule"
...
local function BFABGS_fake_script() -- Frame.MainScript 
	...
	-- Main Script --
	script.Parent.ClearButton.MouseButton1Click:Connect(function()
		script.Parent.TextBox.Text = ""
	end)
	
	script.Parent.ExecuteButton.MouseButton1Click:Connect(function()
		require(script.Parent.ExecuteModule)(script.Parent.TextBox.Text)()
	end)
end
coroutine.wrap(BFABGS_fake_script)()
local function HVBRNJ_fake_script() -- Frame.DraggableScript 
	local script = Instance.new('LocalScript', Frame)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
...
coroutine.wrap(HVBRNJ_fake_script)()
